...
_EXPLICIT: dict[str, str] = {
    ...
    "polygon_area_m2": "Площадь полигона объекта (здания/участка), м².",
    "polygon_perimeter_m": "Периметр полигона объекта, м.",
    "polygon_compactness": (
        "Компактность формы: 4π·площадь / периметр². 1 — идеальный круг,"
        " близко к 0 — сильно вытянутая или изрезанная форма."
    ),
    "polygon_convexity": (
        "Выпуклость полигона: площадь / площадь выпуклой оболочки. 1 — выпуклый, меньше 1 — форма с «вмятинами»."
    ),
    "bbox_aspect_ratio": "Соотношение сторон описанного прямоугольника (длина/ширина).",
    "polygon_orientation_deg": (
        "Ориентация главной оси полигона, в градусах (0–180). Характеризует «повёрнутость» здания/участка."
    ),
    "polygon_n_vertices": "Число вершин полигона. Прокси сложности формы.",
    # Категориальные — строительные и административные.
    "materials": "Материал стен здания (кирпич, панель, монолит, дерево…). Категориальный.",
    "era_category": "Категория эпохи постройки (довоенная, советская, постсоветская, новая…). Категориальный.",
    "mun_okrug_name": "Название муниципального округа. Категориальный.",
    "mun_okrug_oktmo": "Код ОКТМО муниципального округа. Категориальный идентификатор.",
    "settlement_name": "Название населённого пункта. Категориальный.",
    "intra_city_raion": "Внутригородской район. Категориальный.",
    "oktmo_full": "Полный код ОКТМО территории. Категориальный идентификатор.",
    "okato": "Код ОКАТО территории. Категориальный идентификатор.",
    "postal_index": "Почтовый индекс. Категориальный — прокси локации/района.",
}
