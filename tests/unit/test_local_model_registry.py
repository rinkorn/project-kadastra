...
def test_log_run_creates_run_directory(tmp_path: Path, trained_model) -> None:
...
def test_log_run_writes_params_metrics_and_model_files(tmp_path: Path, trained_model) -> None:
    registry = LocalModelRegistry(tmp_path / "models")
...
def test_log_run_returns_unique_id_for_consecutive_calls(tmp_path: Path, trained_model) -> None:
    registry = LocalModelRegistry(tmp_path / "models")
...
def test_log_run_id_starts_with_run_name(tmp_path: Path, trained_model) -> None:
    registry = LocalModelRegistry(tmp_path / "models")
