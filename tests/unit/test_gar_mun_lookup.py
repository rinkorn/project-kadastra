...
def test_picks_kazan_urban_okrug() -> None:
    ...
    addr = _addr(
        [
            {"objectid": 169363, "objectguid": "g1", "name": "Татарстан",
             "typename": "Респ", "level": 1},
            {"objectid": 95235088, "objectguid": "g2", "name": "город Казань",
             "typename": "г.о.", "level": 3},
            {"objectid": 169398, "objectguid": "g3", "name": "Казань",
             "typename": "г", "level": 5},
            {"objectid": 172729, "objectguid": "g4", "name": "Гагарина",
             "typename": "ул", "level": 8},
        ]
    )
    mun = _mun(
        [
            {"objectid": 169363, "parentobjid": None, "oktmo": "92000000",
             "path": "169363"},
            {"objectid": 95235088, "parentobjid": 169363, "oktmo": "92701000",
             "path": "169363.95235088"},
            {"objectid": 169398, "parentobjid": 95235088, "oktmo": "92701000001",
             "path": "169363.95235088.169398"},
            {"objectid": 172729, "parentobjid": 169398, "oktmo": "92701000001",
             "path": "169363.95235088.169398.172729"},
            {"objectid": 71273055, "parentobjid": 172729, "oktmo": "92701000001",
...
def test_picks_rural_raion_for_village_object() -> None:
    ...
    addr = _addr(
        [
            {"objectid": 169363, "objectguid": "g", "name": "Татарстан",
             "typename": "Респ", "level": 1},
            {"objectid": 183244, "objectguid": "g", "name": "Высокогорский",
             "typename": "р-н", "level": 2},
            {"objectid": 9001, "objectguid": "g", "name": "Семиозерское",
             "typename": "с.п.", "level": 4},
            {"objectid": 9002, "objectguid": "g", "name": "Большие Кабаны",
             "typename": "с", "level": 6},
        ]
    )
    mun = _mun(
        [
            {"objectid": 9999, "parentobjid": 9002, "oktmo": "92215820106",
             "path": "169363.183244.9001.9002.9999"},
            {"objectid": 9002, "parentobjid": 9001, "oktmo": "92215820106",
             "path": "169363.183244.9001.9002"},
            {"objectid": 9001, "parentobjid": 183244, "oktmo": "92215820",
             "path": "169363.183244.9001"},
            {"objectid": 183244, "parentobjid": 169363, "oktmo": "92215000",
             "path": "169363.183244"},
        ]
    )
...
def test_returns_null_when_no_okrug_in_path() -> None:
    ...
    addr = _addr(
        [
            {"objectid": 1, "objectguid": "g", "name": "Татарстан",
             "typename": "Респ", "level": 1},
        ]
    )
    mun = _mun(
        [
            {"objectid": 99, "parentobjid": 1, "oktmo": "92000000",
             "path": "1.99"},
        ]
    )
