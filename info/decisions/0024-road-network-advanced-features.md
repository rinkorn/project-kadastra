...
> **Update 2026-08-21:** финальное переобучение квартета выполнено; измеренные ΔMAPE/WAPE/Spearman по классам — в [ADR-0025 «Эмпирический эффект (измеренный)»](0025-misc-enrichment-cbd-heritage-zoouit.md#эмпирический-эффект-измеренный-2026-08-21).
